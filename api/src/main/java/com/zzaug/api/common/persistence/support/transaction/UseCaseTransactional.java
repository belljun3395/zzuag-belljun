package com.zzaug.api.common.persistence.support.transaction;
...
public @interface UseCaseTransactional {
	...
	String value() default ApiJpaDataSourceConfig.TRANSACTION_MANAGER_NAME;

	@AliasFor(annotation = Transactional.class, attribute = "transactionManager")
	String transactionManager() default ApiJpaDataSourceConfig.TRANSACTION_MANAGER_NAME;
