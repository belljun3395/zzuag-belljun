...
import static com.zzaug.api.config.ApiRedisConfig.REDIS_CONNECTION_FACTORY_NAME;
...
public class ApiSessionConfig {
	...
	public static final String SESSION_BEAN_NAME_PREFIX = ApiAppConfig.BEAN_NAME_PREFIX + "Session";
